...
void app_main()
{
    ...
    // xTaskCreatePinnedToCore(light_sensor_task, "Light Sensor Task", 4096, NULL, 1, NULL, 1); // ADC Task auf Core 1
    ...
    xTaskCreate(webServerTask, "Web Server Task", 8192, NULL, 2, NULL);
}
